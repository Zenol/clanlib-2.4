...
/////////////////////////////////////////////////////////////////////////////
// CL_AES192_Encrypt_Impl Construction:

CL_AES192_Encrypt_Impl::CL_AES192_Encrypt_Impl() : initialisation_vector_set(false), cipher_key_set(false), padding_enabled(true), padding_num_additional_padded_blocks(0)
{
	reset();
}

/////////////////////////////////////////////////////////////////////////////
// CL_AES192_Encrypt_Impl Attributes:

CL_DataBuffer CL_AES192_Encrypt_Impl::get_data() const
{
	return databuffer;
}

/////////////////////////////////////////////////////////////////////////////
// CL_AES192_Encrypt_Impl Operations:

void CL_AES192_Encrypt_Impl::reset()
{
	calculated = false;
...
void CL_AES192_Encrypt_Impl::set_iv(const unsigned char iv[16])
{
...
void CL_AES192_Encrypt_Impl::set_padding(bool value, bool use_pkcs7, unsigned int num_additional_padded_blocks)
{
...
void CL_AES192_Encrypt_Impl::set_key(const unsigned char key[24])
{
	cipher_key_set = true;
	extract_encrypt_key192(key, key_expanded);
}

void CL_AES192_Encrypt_Impl::add(const void *_data, int size)
{
	if (calculated)
		reset();
...
void CL_AES192_Encrypt_Impl::calculate()
{
	if (calculated)
		reset();
...
/////////////////////////////////////////////////////////////////////////////
// CL_AES192_Encrypt_Impl Implementation:

void CL_AES192_Encrypt_Impl::process_chunk()
{
