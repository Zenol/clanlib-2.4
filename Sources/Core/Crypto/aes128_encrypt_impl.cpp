...
/////////////////////////////////////////////////////////////////////////////
// CL_AES128_Encrypt_Impl Attributes:

CL_DataBuffer CL_AES128_Encrypt_Impl::get_data() const
{
	return databuffer;
}

/////////////////////////////////////////////////////////////////////////////
// CL_AES128_Encrypt_Impl Operations:

void CL_AES128_Encrypt_Impl::reset()
{
	calculated = false;
...
void CL_AES128_Encrypt_Impl::set_iv(const unsigned char iv[16])
{
...
void CL_AES128_Encrypt_Impl::set_padding(bool value, bool use_pkcs7, unsigned int num_additional_padded_blocks)
{
...
void CL_AES128_Encrypt_Impl::set_key(const unsigned char key[16])
{
	cipher_key_set = true;
	extract_encrypt_key128(key, key_expanded);
}

void CL_AES128_Encrypt_Impl::add(const void *_data, int size)
{
	if (calculated)
		reset();

	if (!initialisation_vector_set)
		throw CL_Exception("AES-128 initialisation vector has not been set");

	if (!cipher_key_set)
		throw CL_Exception("AES-128 cipher key has not been set");
...
void CL_AES128_Encrypt_Impl::calculate()
{
	if (calculated)
		reset();
...
/////////////////////////////////////////////////////////////////////////////
// CL_AES128_Encrypt_Impl Implementation:

void CL_AES128_Encrypt_Impl::process_chunk()
{
