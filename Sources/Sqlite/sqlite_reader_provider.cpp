...
char CL_SqliteReaderProvider::get_column_char(int index) const
{
	return static_cast<char>(sqlite3_column_int(vm, index));
}

unsigned char CL_SqliteReaderProvider::get_column_uchar(int index) const
{
...
unsigned int CL_SqliteReaderProvider::get_column_uint(int index) const
{
