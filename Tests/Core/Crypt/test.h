...
private:
	...
	void test_sha256();
	void test_hash(const CL_SHA256 &sha256, const char *hash_text);
	void test_sha384();
	void test_hash(const CL_SHA384 &sha384, const char *hash_text);
	void test_sha512();
	void test_hash(const CL_SHA512 &sha512, const char *hash_text);
	void test_sha512_224();
	void test_hash(const CL_SHA512_224 &sha512_224, const char *hash_text);
	void test_sha512_256();
	void test_hash(const CL_SHA512_256 &sha512_256, const char *hash_text);
public:
	void fail() const;
